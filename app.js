...
function getRandomImage(keyword, count) {
    ...
    return new Promise(function(resolve, reject) {
        let requestUrl = `https://api.unsplash.com/photos/random/?count=${count}&client_id=lX8gQsO-9qlTIf5vmmNMY5VP_iRUFLQNuR11Cd8J0_c&featured=true&orientation=landscape&query=${keyword}`;
